...
<div id="jawa" class="tabcontentProv" style="display: block;">
  ...
  <div id="suhuJawa" class="tabcontentClimJawa" style="display: block;">
      ...
      <div class="col-md-3">
        <div class="row" style="padding-right: 5px">
          <div class="panel panel-info">
            <div class="panel-heading text-center text-info">Legenda</div>
    ...
    <span>
      ...
      <?php
        $varclim = array('suhu', 'cdd', 'cwd', 'fhl', 'hth', 'hujan', 'r50');
        foreach ($varclim as $value2) {
        $a = ucwords($value2);
        echo "<option value='http://139.162.55.216:8001/files/pdf/jawa-".$value2.".zip'>Jawa - ".$a."</option>"
        }
      ?>
      </select>
      <script type="text/javascript">
  ...
  echo "<div id=".$value."Jawa class='tabcontentClimJawa' style='display: none;'>";
  echo "<div class='row'>";
  echo "<div class='col-md-9'>";
  echo "<div class='embed-responsive embed-responsive-16by9'>";
  echo "<iframe allowfullscreen='true' class='embed-responsive-item' src='ol/php/jawa_'".$value.".php'></iframe>";
  echo "</div>";
  echo "</div>";
  echo "<div class='col-md-3'>";
  echo "<div class='row' style='padding-right: 5px'>";
  echo "<div class='panel panel-info'>";
  echo "<div class='panel-heading text-center text-info'>Legenda</div>";
  ...
  echo '</div></div></div></div></div></div><span><br>';
  echo "<input type='button' class='btn btn-info' value='Download PDF' onclick='Go".$value."()' />";
  echo "<select id='select".$value."'>";
  ...
  echo '<script type="text/javascript">
        function Go'"$value"'(){';
  echo 'var geoportal = document.getElementById("select'"$value"'");';
  echo 'var selectedVal = geoportal.options[geoportal.selectedIndex].value;
        window.open(selectedVal)
        }
        </script>
        </span>
