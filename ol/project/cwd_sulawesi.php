...
<html>
  ...
  <body>
      <div id="map" class="map">
        <div class="map-title">Proyeksi Perubahan Consecutive Wet Days Periode 2032-2040 terhadap Periode 2006-2014 Pulau Sulawesi</div>
      </div>
    <script>
      var map = new ol.Map({
          target: 'map',
          view: viewSulawesi,
          layers: [osm, layer[31], layer[30], layer[29], layer[28]],
